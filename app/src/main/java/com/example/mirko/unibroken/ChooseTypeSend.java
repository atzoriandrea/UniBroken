...
public class ChooseTypeSend extends AppCompatActivity {
    ArrayList<String> cat = new ArrayList<>();
    ArrayList<String> temp;
    ListView listaCat;
    CategoryOptionSend.Adattatore a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a = new CategoryOptionSend.Adattatore(this,cat);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                a = new CategoryOptionSend.Adattatore(ChooseTypeSend.this,searched);
                listaCat.setAdapter(a);
                return false;
            }
        });
        ...
        listaCat.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3){
                ...
                Intent backToList;
                backToList = new Intent(ChooseTypeSend.this,SendSegn.class);
    ...
    public void onBackPressed() {
        Intent indietro;
        if(p1.getId()==3){
            indietro = new Intent(ChooseTypeSend.this,SendSegn.class);
    ...
    public void logout(View view) {
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent logout = new Intent(ChooseTypeSend.this, MainActivity.class);
                // Start the Intent
