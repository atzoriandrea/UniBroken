...
public class CategoryOption extends ListActivity {
    public static class Adattatore extends BaseAdapter {
        ...
        public View getView(int position, View v, ViewGroup vg)
        {
            ...
            if(!s.equals("Tutte le segnalazioni"))
                txt.setText(String.valueOf(SegnFactory.getListaSegnalazioniByType(s).size()) + " segnalazioni");
            else{
                txt.setText(String.valueOf(SegnFactory.getListaSegnalazioni().size()) + " segnalazioni");
            }
